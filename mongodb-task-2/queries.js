...
db.topics.aggregate([
    ...
    {
        $match:{$and:[{$or:[{topic_date:{$gt:new Date("2022-10-01")}},{topic_date:{$lt:new Date("2022-10-30")}}]},
        
          {$or:[{"task_info.due_date":{$gt:new Date("2022-10-01")}},{"task_info.due_date":{$lt:new Date("2022-10-30")}}]}
        ]}
    }
 ]).pretty();
